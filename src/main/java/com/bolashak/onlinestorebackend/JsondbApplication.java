...
// }
// @Bean
// CommandLineRunner run ner(ProductService productService) {
// return args -> {
// // Read JSON and write to DB
// ObjectMapper mapper = new ObjectMapper();
// TypeReference<List<Product>> typeReference = new
// TypeReference<List<Product>>() {};
// InputStream inputStream =
// getClass().getClassLoader().getResourceAsStream("data/products.json");
// try {
